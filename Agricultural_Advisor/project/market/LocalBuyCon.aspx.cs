...
{
    public partial class LocalBuyCon : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //product information is comming from grid view from local market page 
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //   string va = "Your Name" + TextBox1.Text + "</br>" + "Book Name:" + TextBox5.Text + "</br>" + "Date of Order:" + TextBox6.Text + "</br>" + "Quantity:" + TextBox7.Text + "</br>" + "Payment:" + TextBox2.Text;
